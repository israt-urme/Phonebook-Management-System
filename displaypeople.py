...
class Display(Toplevel):
    def __init__(self,person_id): #constructor
        ...
        #top frame design
        self.top_image=PhotoImage(file='icons/disp.png')
        self.top_image_label=Label(self.top, image=self.top_image,bg='gray')
        self.top_image_label.place(x=100,y=35)
        
        #header title
        self.heading=Label(self.top, text='Display Person Information',font='arial 18 bold',bg='gray',fg='#FED805')
        ...
        #lastname
        self.label_lname= Label(self.bottom, text="Last Name",font='arial 15 bold',bg='white',fg='black' )
        ...
        self.entry_pn.config(state='disabled')
        ...
        self.entry_adr.config(state='disabled')
